    ...
    public partial class GetSpecialMark : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pmno == null)
                {
                    string warning = string.Format("参数Pmno，CodeCompany不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Base/GetSpecialMark.aspx?Pmno=20151119000281&CodeCompany=14");
