...
namespace M_DL_Gwtxc.Service.Consign
{
    public partial class GetConsign : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数StartRow，Count，CodeCompany，StartTime，EndTime不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Consign/GetConsign.aspx?StartRow=1&Count=14&CodeCompany=14&StartTime=2015-08-19&EndTime=2015-09-19");
