    ...
    public partial class GetHandoverRecord : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数CurTime，CodeUser不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Handover/GetHandoverRecord.aspx?Time=2015/12/16 08:44:52&CodeUser=16");
