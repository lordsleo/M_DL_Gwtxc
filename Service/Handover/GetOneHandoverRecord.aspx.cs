    ...
    public partial class GetOneHandoverRecord : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (codeToken == null)
                {
                    string warning = string.Format("参数CodeToken不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Handover/GetOneHandoverRecord.aspx?CodeToken=201550230250548004");
