...
namespace M_DL_Gwtxc.Service.Handover
{
    public partial class WorkHandover : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数CodeUserFirst，CodeCompanyFirst，CodeUserSecond，CodeCompanySecond不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Handover/WorkHandover.aspx?CodeUserFirst=227&CodeCompanyFirst=14&CodeUserSecond=336&CodeCompanySecond=14&Text=dddddd");
