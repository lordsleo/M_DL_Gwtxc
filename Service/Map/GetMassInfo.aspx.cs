...
namespace M_DL_Gwtxc.Service.Map
{
    public partial class GetMassInfo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (massNum == null)
                {
                    string warning = string.Format("参数MassNum不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Map/GetMassInfo.aspx?MassNum=1130-320");
