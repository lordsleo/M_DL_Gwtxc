    ...
    public partial class GetSavedArea : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数Pmno,Tbno，AreaType不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Slip/GetSavedArea.aspx?Pmno=20151009000041&Tbno=20151020063793&AreaType=0");
