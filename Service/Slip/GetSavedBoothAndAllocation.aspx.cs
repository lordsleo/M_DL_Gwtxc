    ...
    public partial class GetSavedBoothAndAllocation : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数Tbno，CarriesType不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Slip/GetSavedBoothAndAllocation.aspx?Tbno=20151221066196&CarriesType=0");
