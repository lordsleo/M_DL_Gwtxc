    ...
    public partial class GetTeamWorkerAndMark : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数Pmno，Tbno不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Slip/GetTeamWorkerAndMark.aspx?Pmno=20151212000565&Tbno=20151221066216");
