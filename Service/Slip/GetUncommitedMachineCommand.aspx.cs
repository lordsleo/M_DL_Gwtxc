    ...
    public partial class GetUncommitedMachineCommand : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (codeUser == null)
                {
                    string warning = string.Format("参数CodeUser不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Slip/GetUncommitedMachineCommand.aspx?CodeUser=71B4CD89E6654D84B8AED9116DDB1C4C");
