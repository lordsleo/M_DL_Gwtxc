    ...
    public partial class GetStock : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数StartRow，Count，CodeCompany不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Stock/GetStock.aspx?StartRow=1&Count=14&CodeCompany=14");
