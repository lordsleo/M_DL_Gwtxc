...
namespace M_DL_Gwtxc.Service.Stock
{
    public partial class GetStockDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数Gbno,CodeStorage,CodeBooth不能为nul！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Stock/GetStockDetail.aspx?Gbno=190c89fd55dc45ee9260cf51a171daef&CodeStorage=20975&CodeBooth=21295");
