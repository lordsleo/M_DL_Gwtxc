...
namespace M_DL_Gwtxc.Service.Vehicle
{
    public partial class EndWork : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数Id,EndUserName，endTime，CodeWorkTeam，DayNight，Count不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Vehicle/EndWork.aspx?Id=14&EndUserName=张三&EndTime=8:27:55&CodeWorkTeam=7&DayNight=白班&Count=");
