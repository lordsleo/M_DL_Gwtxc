    ...
    public partial class GetEndWork : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数No,CodeCompany，RecognizeMethod不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Vehicle/GetEndWork.aspx?No=690000&CodeCompany=77&RecognizeMethod=CARD");
