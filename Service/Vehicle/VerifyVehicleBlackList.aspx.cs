    ...
    public partial class VerifyVehicleBlackList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数No,RecognizeMethod不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Vehicle/VerifyVehicleBlackList.aspx?No=690000&RecognizeMethod=CARD");
