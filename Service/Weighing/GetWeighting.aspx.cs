...
namespace M_DL_Gwtxc.Service.Weighing
{
    public partial class GetWeighting : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数StartRow，Count，CodeDepartment，TeamDate不能为null！举例：http://218.92.115.55/M_DL_Gwtxc/Service/Weighing/GetWeighting.aspx?StartRow=1&Count=14&CodeDepartment=11&DayNight=白班&TeamDate=2015-08-19");
